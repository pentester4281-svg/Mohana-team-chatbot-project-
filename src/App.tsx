        ...
        {viewingDocs ? (
          ...
          >
            <motion.div 
              ...
              className={`w-24 h-24 rounded-3xl overflow-hidden mb-8 shadow-2xl border-2 ${darkMode ? 'border-white/10' : 'border-black/5'}`}
            >
              <img 
                src="https://content3.jdmagicbox.com/comp/salem/q8/0427px427.x427.001233955406.p1q8/catalogue/excel-engineering-college-sankari-west-salem-engineering-colleges-4gxdumr.jpg" 
            ...
            <motion.div
              ...
              className="w-full max-w-4xl mb-10 overflow-hidden rounded-3xl shadow-2xl border-4 border-white/10"
            >
              <img
                src="https://content.jdmagicbox.com/comp/salem/q8/0427px427.x427.001233955406.p1q8/catalogue/excel-engineering-college-sankari-west-salem-engineering-colleges-3f10vwp.jpg"
                alt="Excel Polytechnic College Campus"
            ...
            >
              <button
                ...
                className="group flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-emerald-600 to-emerald-500 text-white rounded-2xl font-bold text-lg hover:from-emerald-700 hover:to-emerald-600 transition-all shadow-xl hover:shadow-emerald-500/20 active:scale-95"
              >
                Start Enquiry
